...
impl FeatureInitContext {
    ...
    pub fn port<R: guinea_core::scope::Reducer>(&self) -> impl Fn(R::Push) + 'static {
        ...
        let scope = std::rc::Rc::downgrade(&self.scope);
        move |msg| {
...
struct DebugRegistration {
    id: usize,
    registry: std::rc::Rc<guinea_core::actor::registry::DebugRegistry>,
}

impl guinea_core::scope::Teardown for DebugRegistration {
    fn teardown(self) {
