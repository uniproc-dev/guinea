...
use guinea_core::trace::{DispatchMeta, current_meta, is_scope_enabled};
...
/// contracts live outside `guinea` (e.g. an app's own contracts crate) don't
/// need a `guinea` dependency just to name this bound.
